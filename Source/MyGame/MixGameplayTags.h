...
namespace MixGameplayTags
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attack_Ranged);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Attack_Melee);
	
	MYGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Hero_Name_Ashe);
	MYGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Hero_Name_Zed);
